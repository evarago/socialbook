...
// Criar usuário vai inserir um usuário novo no banco de dados
...
// Buscar usuários vai retornar toda a lista de usuários registrados
...
// Buscar usuário vai retorno um usuário específico conforme o id
...
// Atualizar usuário alterar os dados do usuário no banco
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível atualizar um usuário diferente"))
		return
	}
...
// Excluir os dados de um usuário no banco
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível excluir um usuário diferente"))
		return
	}
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if erro = seguranca.VerificaSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("A senha atual não condiz com a atual"))
		return
	}
