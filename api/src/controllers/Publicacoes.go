...
// Criar publicação adiciona uma nova publicação no banco de dados
...
// BuscarPublicacoes retorna uma relação de publicações do banco de dados
...
// BuscarPublicacao retorna uma publicação especifica pelo ID
...
// DeletarPublicacao exclui uma publicação do banco de dados
...
func BuscarPublicacaoesPorUsuario(w http.ResponseWriter, r *http.Request) {
	parametros := mux.Vars(r)
...
// DescurtirPublicacao adiciona uma curtida a uma publicação
